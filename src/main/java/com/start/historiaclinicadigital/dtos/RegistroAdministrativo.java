...
public class RegistroAdministrativo {
    ...
    public RegistroAdministrativo(String nombre, String apellido, String email, int documento, String password, String telefono) {
        this.nombre = nombre;
